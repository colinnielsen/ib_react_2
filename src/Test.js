        ...
        return (
            <body className="slides zen horizontal">
                ...
                <svg xmlns="//www.w3.org/2000/svg" style={{ display: 'none' }}>
                    ...
                    <symbol id="drop-down" viewBox="0 0 16 16">
                        <polyline strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={10} points="1,5 8,12 15,5" fill="none" />
                    </symbol>
                        ...
                        <div className="cell">
                            <span className="prevSlide">
                                <svg className="sideArrow">
                                    <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#arrow-left" />
                                </svg>
                            </span>
                        </div>
                    </div>
                ...
                <nav className="panel top">
                    <div className="sections">
                        ...
                        <div className="right">
                            <span className="button actionButton sidebarTrigger" data-sidebar-id={9} style={{ paddingTop: '10px !important', paddingRight: '50px !important' }}>
                                <svg style={{ width: 30, height: 30 }}>
                                    <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#slides" />
                                </svg>
                            </span>
                        </div>
                    </div>
          ...
          <nav className="panel bottom" style={{ zIndex: 1000 }}>
                        <div className="sections">
                            <div className="left">
                                <button className="button hideForDesktop" data-on-click="http://isabelleballu.com/test/archive/edit/francpairon.html" style={{ paddingLeft: '25px !important' }}>
                                    <svg style={{ width: 40, height: 40 }}>
                                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#info" />
                                    </svg>
                                </button>
                            </div>
                            ...
                            <div className="right">
                                <span data-dropdown-id="s1" className="button actionButton dropdownTrigger" style={{ paddingTop: '10px !important', paddingRight: '50px !important' }}>
                ...
                <section className="slide fade kenBurns" data-name={2}>
                        ...
                        <div className="container">
                          ...
                          and I will give you a complete account of the system."</h4>
                                                ...
                                                <ul className="museum" style={{ paddingTop: 20 }}>
                                                    <li>
                                                        <a href="#">
                                                            <svg style={{ width: '26.67px', height: 20 }}>
                                                                <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#headphones" />
                                                            </svg>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <svg style={{ width: 20, height: 20 }}>
                                                                <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#identity" />
                                                            </svg>
                                                ...
                                                <a href="#">
                                                    <p className="uppercase" style={{ paddingTop: 20 }}>More on this collection …</p>
                                                </a>
                                            </li>
                    ...
                    <nav className="panel bottom" style={{ zIndex: 1000 }}>
                        <div className="sections">
                            <div className="left">
                                <button className="button popupTrigger hideForDesktop" data-popup-id="p2" style={{ paddingLeft: '25px !important' }}>
                                    <svg style={{ width: 40, height: 40 }}>
                                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#info" />
                                    </svg>
                                </button>
                            ...
                            <div className="right">
                                <span data-dropdown-id="s2" className="button actionButton dropdownTrigger" style={{ paddingTop: '10px !important', paddingRight: '50px !important' }}>
                                    <i className="material-icons">share</i>
                                </span>
                            </div>
                        </div>
                ...
                <div className="popup hideForDesktop" data-popup-id="p2">
                    ...
                    texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</h5>
                                    <ul className="museum" style={{ paddingTop: '5%' }}>
                                        <li>
                                            <a href="#">
                                                <svg style={{ width: '26.67px', height: 20 }}>
                                                    <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#headphones" />
                ...
                <section className="slide fade kenBurns" data-name={3}>
                    ...
                    <nav className="panel bottom" style={{ zIndex: 1000 }}>
                        <div className="sections">
                            <div className="left">
                                <button className="button popupTrigger hideForDesktop" data-popup-id="p3" style={{ paddingLeft: '25px !important' }}>
                                    <svg style={{ width: 40, height: 40 }}>
                                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#info" />
                                    </svg>
                                </button>
                            ...
                            <div className="right">
                                <span data-dropdown-id="s3" className="button actionButton dropdownTrigger" style={{ paddingTop: '10px !important', paddingRight: '50px !important' }}>
                                    <i className="material-icons">share</i>
                                </span>
                            </div>
                        </div>
                    ...
                    texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</h5>
                                    <ul className="museum" style={{ paddingTop: '5%' }}>
                                        ...
                                        <li>
                                            <a href="#">
                                                <svg style={{ width: 20, height: 20 }}>
                                                    <use xmlslink="http://www.w3.org/1999/xlink" xlinkHref="#defile" />
                                                </svg>
                                                <p className="uppercase">Defile</p>
                                            </a>
                                        </li>
                ...
                <section className="slide whiteSlide fade kenBurns" data-name={4}>
                    ...
                    <nav className="panel bottom" style={{ zIndex: 1000 }}>
                        <div className="sections">
                            <div className="left">
                                <button className="button popupTrigger hideForDesktop" data-popup-id="p4" style={{ paddingLeft: '25px !important' }}>
                                    <svg style={{ width: 40, height: 40 }}>
                                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#info" />
                                    </svg>
                                </button>
                            ...
                            <div className="right">
                                <span data-dropdown-id="s4" className="button actionButton dropdownTrigger" style={{ paddingTop: '10px !important', paddingRight: '50px !important' }}>
                                    <i className="material-icons">share</i>
                                </span>
                            </div>
                        </div>
                ...
                <section className="slide whiteSlide fade kenBurns slideshow" data-name={5}>
                    ...
                    <nav className="panel bottom" style={{ zIndex: 1000 }}>
                        <div className="sections">
                            <div className="left">
                                <button className="button popupTrigger hideForDesktop" data-popup-id="p5" style={{ paddingLeft: '25px !important' }}>
                                    <svg style={{ width: 40, height: 40 }}>
                                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#info" />
                                    </svg>
                                </button>
                            ...
                            <div className="right">
                                <span data-dropdown-id="s5" className="button actionButton dropdownTrigger" style={{ paddingTop: '10px !important', paddingRight: '50px !important' }}>
                                    <i className="material-icons">share</i>
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="background" style={{ backgroundImage: 'url(assets/img/expo4.jpeg)', backgroundPosition: 'center center' }} />
                    <div className="background" style={{ backgroundImage: 'url(assets/img/expo5.jpeg)', backgroundPosition: 'center center' }} />
